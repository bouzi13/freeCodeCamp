...
Otro interesante "par clave-valor" en el primer objeto es `"codeNames":["Juggernaut","vallada","ButterCup"]`. Aquí `codeNames` es la clave y su valor es un arreglo de tres cadenas. Es posible tener arreglos de objetos así como una clave con un arreglo como un valor.
